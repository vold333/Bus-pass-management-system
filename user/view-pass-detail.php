    ...
    function PrintDiv() {    
       ...
       popupWin.document.write(  divToPrint.innerHTML );
        popupWin.document.close();
            ...
            function click_here() {    
       var view = document.getElementById('form');
       var popup = window.open('', '_blank', 'width=500,height=500');
       popup.document.open();
       popup.document.write(  form.innerHTML );
...
<tr>
  ...
  <div class="form" id="view"><tr>
  <th scope>uploaded form</th>
    <td colspan="3"><img src="images/<?php  echo ($row->formupload);?>"></td>
  </tr> 
  </div>                                 
   <?php $cnt=$cnt+1;}} ?>
   </table>
