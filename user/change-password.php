...
$sql ="SELECT id FROM user WHERE id=:userid and password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update user set password=:newpassword where id=:userid";
...
echo "<script>window.location.href ='user/change-password.php'</script>";
} else {
