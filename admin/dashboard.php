                        ...
                        <div class="alert alert-danger text-center">
                            ...
                            <div class="panel-body cyan">
                                <i class="fa fa-calendar fa-3x"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>
                                    <?php echo htmlentities($totalcat); ?>
                                </b><a href="manage-category.php">Total Bus Category</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div class="alert alert-success text-center">
                            ...
                            <div class="panel-body cyan">
                                ...
                                </b><a href="manage-pass.php"> Total Passes</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="alert alert-info text-center">
                            ...
                            ?>
                            <div class="panel-body cyan">
                                <i class="fa fa-pencil-square-o fa-3x"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>
                                    <?php echo htmlentities($today_pass); ?>
                                </b> <a href="todays-pass.php">Pass Created Today</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="alert alert-info text-center">
                            ...
                            <div class="panel-body green">
                                <i class="fa  fa-pencil fa-3x"></i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>
                                    <?php echo htmlentities($seven_pass); ?>
                                </b> <a href="last-7days-pass.php">Pass Created in Last one week</a>
                            </div>
                        </div>
                    </div>
